    ...
    <article>
      <Container className="px-0">
        ...
        <Documentation
          title="Navbar"
          description=""
          scope={{ Nav, Card, Navbar, Container, Image }}
...
import ReactLogo from "src/assets/img/technologies/react-logo-transparent.svg";`}
          example={`<Navbar variant="dark" expand="lg" bg="white" className="navbar-transparent  my-2">
  <Container className="position-relative">
    ...
    <Navbar.Toggle aria-controls="navbar-default-primary" />
        ...
        <Documentation
          title="Navbar colors"
          description=""
          scope={{ useEffect, useState, Nav, Card, Navbar, Image, Container }}
